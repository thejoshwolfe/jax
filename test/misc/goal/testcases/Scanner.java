/*
 * This code was modified from its original version to conform to the java language version 1.4.
 * it was also put in a different package.
 * Generic types were removed.
 * anonymous class for LRUCache was put in a different file "Scanner_LRUCache.java".
 */
...
public final class Scanner implements Iterator {
    ...
    private LRUCache patternCache = new Scanner_LRUCache(7);
